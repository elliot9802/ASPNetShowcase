...
SELECT @nrFriendsAffected = COUNT(*)
FROM supusr.Friends
WHERE Seeded = @Seeded;
SELECT @nrAddressesAffected = COUNT(*)
FROM supusr.Addresses
WHERE Seeded = @Seeded;
SELECT @nrPetsAffected = COUNT(*)
FROM supusr.Pets
WHERE Seeded = @Seeded;
SELECT @nrQuotesAffected = COUNT(*)
FROM supusr.Quotes
WHERE Seeded = @Seeded;

DELETE FROM supusr.Friends
WHERE Seeded = @Seeded;
DELETE FROM supusr.Addresses
WHERE Seeded = @Seeded;
DELETE FROM supusr.Pets
WHERE Seeded = @Seeded;
DELETE FROM supusr.Quotes
WHERE Seeded = @Seeded;

SELECT *
FROM gstusr.vwInfoDb;
